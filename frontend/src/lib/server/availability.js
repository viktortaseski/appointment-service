...
export function buildTimeSlotsFromTimes(startTime, endTime, intervalMinutes) {
...
export function buildTimeSlotsFromClinic(clinic) {
...
export function computeBlockedTimes(dateKey, records, slots = DEFAULT_TIME_SLOTS) {
